    ...
    <div className=" w-11/12 p-5 mt-5">
      <div className=" flex justify-between text-sm sm:text-lg mb-3 font-poppins pr-5 sm:px-5">
        ...
        <div className="flex w-4/12 sm:w-6/12">
          ...
          <div className=" w-full font-bold  text-center  text-color_gray_1 ">Rol</div>
      ...
      <div className="items_clientes overflow-y-auto sm:px-5 pr-5">
        {caseros.map(cliente => (
          <Link
            key={cliente.id}
            to={`/trabajadores/${cliente.id}/chat`}
          ...
          >
            ...
            <div className="w-4/12 sm:w-6/12 flex ">
              <span className=" text-center   w-full hidden sm:inline sm:mx-2">939616358</span>
              <span className=" lg:inline hidden text-center w-full truncate">77068139</span>
